...
const styles = {
  ...
  callerAvatar: {
    ...
    border: "2px solid rgba(242,202,80,0.18)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    color: "var(--accent)",
  ...
  acceptBtn: {
    ...
    borderRadius: "50%",
    border: "none",
    background: "linear-gradient(135deg, var(--green), #607b54)",
    color: "#fff",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    cursor: "pointer",
    boxShadow: "0 4px 20px rgba(136, 168, 121, 0.28)",
  ...
  rejectBtn: {
    ...
    borderRadius: "50%",
    border: "none",
    background: "linear-gradient(135deg, var(--red), #8d342e)",
    color: "white",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    cursor: "pointer",
    boxShadow: "0 4px 20px rgba(215,107,98,0.32)",
    transition: "transform 0.2s",
  },
  controlBtn: {
    width: "48px",
